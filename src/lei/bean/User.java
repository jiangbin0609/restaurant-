...
public class User implements Serializable {
	...
	public String toString() {
		return "Users [usersId=" + usersId + ", usersName=" + usersName + ", usersPass=" + usersPass
				+ ", usersTrueName=" + usersTrueName + ", usersAddress=" + usersAddress + ", usersPhone=" + usersPhone
				+ ", usersEmail=" + usersEmail + ", userCon=" + userCon + "]";
	}
